...
public class ReportRecord extends UpdatableRecordImpl<ReportRecord> implements Record9<Long, LocalDateTime, LocalDateTime, LocalDateTime, String, String, ReportStatus, String, ReportType> {

    private static final long serialVersionUID = -2110265575;
     ...
     */
    @Override
    public Row9<Long, LocalDateTime, LocalDateTime, LocalDateTime, String, String, ReportStatus, String, ReportType> fieldsRow() {
     ...
     */
    @Override
    public Row9<Long, LocalDateTime, LocalDateTime, LocalDateTime, String, String, ReportStatus, String, ReportType> valuesRow() {
     ...
     */
    @Override
    public Field<ReportType> field9() {
     ...
     */
    @Override
    public ReportRecord value9(ReportType value) {
        setType(value);
        return this;
    }
     ...
     */
    @Override
    public ReportRecord values(Long value1, LocalDateTime value2, LocalDateTime value3, LocalDateTime value4, String value5, String value6, ReportStatus value7, String value8, ReportType value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReportRecord(Long id, LocalDateTime fromTime, LocalDateTime toTime, LocalDateTime createdAt, String partyId, String partyContractId, ReportStatus status, String timezone, ReportType type) {
        super(Report.REPORT);
