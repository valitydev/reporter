...
import static dev.vality.reporter.domain.Tables.ADJUSTMENT_AGGS_BY_HOUR;
import static dev.vality.reporter.domain.tables.Adjustment.ADJUSTMENT;
...
public class AdjustmentDaoImpl extends AbstractDao implements AdjustmentDao {
    ...
    public Long getFundsAdjustedAmount(String partyId,
        ...
        if (reportFromTime.until(toTime, ChronoUnit.HOURS) > 1) {
            ...
            return AccountingDaoUtils.getFundsAmountResult(fundsAdjustedAmountResult);
        }
    }
