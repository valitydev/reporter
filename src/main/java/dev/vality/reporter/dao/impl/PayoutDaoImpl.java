...
import dev.vality.reporter.dao.PayoutDao;
...
import dev.vality.reporter.domain.tables.records.PayoutAccountRecord;
import dev.vality.reporter.domain.tables.records.PayoutInternationalAccountRecord;
import dev.vality.reporter.domain.tables.records.PayoutRecord;
import dev.vality.reporter.domain.tables.records.PayoutStateRecord;
...
import static dev.vality.reporter.domain.Tables.PAYOUT_AGGS_BY_HOUR;
import static dev.vality.reporter.domain.tables.Payout.PAYOUT;
import static dev.vality.reporter.domain.tables.PayoutAccount.PAYOUT_ACCOUNT;
import static dev.vality.reporter.domain.tables.PayoutInternationalAccount.PAYOUT_INTERNATIONAL_ACCOUNT;
import static dev.vality.reporter.domain.tables.PayoutState.PAYOUT_STATE;
...
public class PayoutDaoImpl extends AbstractDao implements PayoutDao {
    ...
    public Long getFundsPayOutAmountWithAggs(String partyId,
        ...
        return oldPayoutFundsAmount +
                AccountingDaoUtils.getFundsAmountResult(fundsPayOutAmountResult) +
                youngPayoutFundsAmount;
    }
    ...
    private Long getPayoutFundsAmount(String partyId,
        ...
        var cancelledPayoutFundsAmount =
                getCancelledPayoutFundsAmountQuery(partyId, shopId, currencyCode, fromTime, toTime)
                        .fetchOne();
        return AccountingDaoUtils.getFundsAmountResult(successPayoutFundsAmount) -
                AccountingDaoUtils.getFundsAmountResult(cancelledPayoutFundsAmount);
    }
