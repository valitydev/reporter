...
public class ReportsTestData {
    ...
    public static PaymentRecord buildPaymentRecord(int index,
        ...
        payment.setTool(dev.vality.reporter.domain.enums.PaymentTool.bank_card);
        payment.setFlow(PaymentFlow.instant);
        payment.setStatus(dev.vality.reporter.domain.enums.InvoicePaymentStatus.captured);
